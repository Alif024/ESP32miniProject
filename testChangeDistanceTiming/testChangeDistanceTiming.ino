...
unsigned long long Value = 6597069787676;
// Storage for the recorded code, pre-filled with NEC data
unsigned int testTiming[] = { 9050, 4550, 600, 1650, 600, 500 };
...
void updateDistanceWidthTimingInfo() {
  sDistanceWidthTimingInfo.HeaderMarkMicros = testTiming[0];
  sDistanceWidthTimingInfo.HeaderSpaceMicros = testTiming[1];
  sDistanceWidthTimingInfo.OneMarkMicros = testTiming[2];
  sDistanceWidthTimingInfo.OneSpaceMicros = testTiming[3];
  sDistanceWidthTimingInfo.ZeroMarkMicros = testTiming[4];
  sDistanceWidthTimingInfo.ZeroSpaceMicros = testTiming[5];
}
...
void loop() {
  // updateDistanceWidthTimingInfo();
  // // แสดงผลข้อมูลในอาร์เรย์
  // printDistanceWidthTimingInfo();

  sDecodedRawDataArray[0] = Value;
  Serial.println(sDecodedRawDataArray[0], HEX);
  delay(5000);
}
...
//                  sizeof(sDistanceWidthTimingInfo))
//           != 0) {
